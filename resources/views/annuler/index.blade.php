...
@section('main')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5 class="m-0"><a href="">Dashboard</a> / <span>Alertes annulées</span>  </h5>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                          <h5>Alertes Confirmés</h5>
                           <a href="{{route('Annuler-Alerte.create')}}">Annuler une Alerte</a>
                        </div>
                        ...
                        <div class="card-body">
                           <table class='table table-hover'>
                                ...
                                <tbody>
                                   ...
                                   @foreach($annulers as $annuler)
                                    <td>{{$loop->index+1}}</td>
                                    <td>{{$annuler->designation}}</td>
                                    <td>{{$annuler->adresse}} <td>
